...
**Twemoji v14.0** aims to be a superset of the [Unicode 14.0 spec](https://unicode.org/versions/Unicode14.0.0/) and supports the [Emoji 14.0 spec](https://www.unicode.org/reports/tr51/tr51-21.html). <del>_We do not support custom emoji._<del>
